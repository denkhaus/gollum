...
// Source: pkg/shared/agent.go
//
// Generated by this command:
//
//	mockgen -source=pkg/shared/agent.go -destination=pkg/shared/agent_mock.go -package=shared github.com/denkhaus/gollum/pkg/shared Agent
//
