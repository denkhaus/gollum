	...
	testCases := []struct {
	...
	}{
		{
			...
			files: []string{
				...
				"arithmetic-computed.xml",
				"assign-input-to-output.xml",
				"computed-output.xml",
				"flow-with-strategy.xml",
				"flow-with-strategy-type.xml",
				"jsonpath-extraction.xml",
				"llm-complexity-example.xml",
				"verbose-example-flow.xml",
			},
		},
		{
