...
//
//	mockgen -source=flows/executor/executor.go -destination=flows/executor/executor_mock.go -package=executor github.com/denkhaus/gollum/pkg/flows/executor FlowExecutorService
//
...
func (m *MockFlowExecutorInstance) Run() (*FlowResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Run")
	ret0, _ := ret[0].(*FlowResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
