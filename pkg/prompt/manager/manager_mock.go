...
//
//	mockgen -source=prompt/manager/manager.go -destination=prompt/manager/manager_mock.go -package=manager github.com/denkhaus/gollum/pkg/prompt/manager PromptManager
//
