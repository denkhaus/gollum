...
//
//	mockgen -source=pkg/channel/interface.go -destination=pkg/channel/facade_mock.go -package=channel github.com/denkhaus/gollum/pkg/channel ChannelFacade,Channel
//
