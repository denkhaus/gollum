...
// Source: pkg/channel/interface.go
//
// Generated by this command:
//
//	mockgen -source=pkg/channel/interface.go -destination=pkg/channel/facade_mock.go -package=channel
//
...
func (m *MockChannelFacade) SubmitInput(session *shared.Session, input string) (*InputResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitInput", session, input)
...
func (mr *MockChannelFacadeMockRecorder) SubmitInput(session, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitInput", reflect.TypeOf((*MockChannelFacade)(nil).SubmitInput), session, input)
}
