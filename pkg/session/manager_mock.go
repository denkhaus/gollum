...
func (m *MockSessionManager) CreateSession(sessionID string, channelID uuid.UUID) (*Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockSessionManager) GetSessionsByChannel(channelID uuid.UUID) []*Session {
	m.ctrl.T.Helper()
