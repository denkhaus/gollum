...
//
//	mockgen -source=hooks/manager.go -destination=hooks/manager_mock.go -package=hooks github.com/denkhaus/gollum/pkg/hooks HookManager
//
...
func (m *MockHookManager) RegisterAgentHook(fn TypedHookFunc[AgentPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterExecutorHook(fn TypedHookFunc[ExecutorPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterFileHook(fn TypedHookFunc[FilePayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterLLMHook(fn TypedHookFunc[LLMPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterSessionHook(fn TypedHookFunc[SessionPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterSkillHook(fn TypedHookFunc[SkillPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) RegisterToolHook(fn TypedHookFunc[ToolPayload], meta TypedHookMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockHookManager) TriggerAgentHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[AgentPayload]) TypedHookResult[AgentPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerAgentHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[AgentPayload])
	return ret0
}
...
func (m *MockHookManager) TriggerExecutorHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[ExecutorPayload]) TypedHookResult[ExecutorPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerExecutorHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[ExecutorPayload])
	return ret0
}
...
func (m *MockHookManager) TriggerFileHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[FilePayload]) TypedHookResult[FilePayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerFileHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[FilePayload])
	return ret0
}
...
func (m *MockHookManager) TriggerLLMHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[LLMPayload]) TypedHookResult[LLMPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerLLMHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[LLMPayload])
	return ret0
}
...
func (m *MockHookManager) TriggerSessionHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[SessionPayload]) TypedHookResult[SessionPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerSessionHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[SessionPayload])
	return ret0
}
...
func (m *MockHookManager) TriggerSkillHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[SkillPayload]) TypedHookResult[SkillPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerSkillHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[SkillPayload])
	return ret0
}
...
func (m *MockHookManager) TriggerToolHooks(ctx context.Context, point HookPoint, hookCtx *TypedHookContext[ToolPayload]) TypedHookResult[ToolPayload] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TriggerToolHooks", ctx, point, hookCtx)
	ret0, _ := ret[0].(TypedHookResult[ToolPayload])
	return ret0
}
...
func (mr *MockHookManagerMockRecorder) WithAgentHooks(ctx, loggingContext, point, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithAgentHooks", reflect.TypeOf((*MockHookManager)(nil).WithAgentHooks), ctx, loggingContext, point, work)
}
...
func (mr *MockHookManagerMockRecorder) WithFileHooks(ctx, loggingContext, point, filePath, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithFileHooks", reflect.TypeOf((*MockHookManager)(nil).WithFileHooks), ctx, loggingContext, point, filePath, work)
}
...
func (mr *MockHookManagerMockRecorder) WithFileReadHooks(ctx, loggingContext, filePath, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithFileReadHooks", reflect.TypeOf((*MockHookManager)(nil).WithFileReadHooks), ctx, loggingContext, filePath, work)
}
...
func (mr *MockHookManagerMockRecorder) WithFileWriteHooks(ctx, loggingContext, filePath, content, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithFileWriteHooks", reflect.TypeOf((*MockHookManager)(nil).WithFileWriteHooks), ctx, loggingContext, filePath, content, work)
}
...
func (mr *MockHookManagerMockRecorder) WithLLMHooks(ctx, loggingContext, prompt, model, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithLLMHooks", reflect.TypeOf((*MockHookManager)(nil).WithLLMHooks), ctx, loggingContext, prompt, model, work)
}
...
func (mr *MockHookManagerMockRecorder) WithSessionHooks(ctx, loggingContext, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithSessionHooks", reflect.TypeOf((*MockHookManager)(nil).WithSessionHooks), ctx, loggingContext, work)
}
...
func (mr *MockHookManagerMockRecorder) WithToolHooks(ctx, loggingContext, toolName, args, work any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithToolHooks", reflect.TypeOf((*MockHookManager)(nil).WithToolHooks), ctx, loggingContext, toolName, args, work)
}
