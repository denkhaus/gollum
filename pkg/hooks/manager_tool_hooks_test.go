...
func TestHookManager_WithToolHooks(t *testing.T) {
	t.Run("successfully executes tool with before and after hooks", func(t *testing.T) {
		...
		result, err := hm.WithToolHooks(context.Background(), shared.SessionContext{SessionID: sessionID, ChannelID: uuid.New(), AgentID: agentID}, shared.ToolName("test-tool"), args, func() (map[string]any, error) {
	...
	t.Run("before hook can modify args", func(t *testing.T) {
		...
		result, err := hm.WithToolHooks(context.Background(), shared.SessionContext{SessionID: sessionID, ChannelID: uuid.New(), AgentID: agentID}, "test-tool", args, func() (map[string]any, error) {
	...
	t.Run("rejects empty tool name", func(t *testing.T) {
		...
		_, err := hm.WithToolHooks(context.Background(), shared.SessionContext{SessionID: sessionID, ChannelID: uuid.New(), AgentID: agentID}, "", args, func() (map[string]any, error) {
			return map[string]any{"output": "success"}, nil
		})
	...
	t.Run("rejects nil work function", func(t *testing.T) {
		...
		_, err := hm.WithToolHooks(context.Background(), shared.SessionContext{SessionID: sessionID, ChannelID: uuid.New(), AgentID: agentID}, "test-tool", args, nil)
